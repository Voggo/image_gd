...
pub use compression::{
    ...
    DEFAULT_ALIGN_ROWS_TO_WORD, DecompressAnalytics, DecompressFileData, DecompressRowsData,
    DeviationData, DeviationSample, EgdFile, EncodeData, EncodeDataFusedDictionary,
    EncodeDataHuffman, EncodeDataHuffmanBaseIdOnly, EncodeDataOptimized, EncodeDataRLE,
    EncodedData, EntropyNaive, EntropyBatched, EntropyStrideSampled, EntropyStrideSampledBatched, FORMAT_VERSION, FeatureSpec,
    ...
    PreprocessOptions, RleDeviationData, SaveEgdFile, SaveIgdFile, SelectBases, SelectBasesDebug,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataHuffman, EncodeDataHuffmanBaseIdOnly, EncodeDataOptimized, EncodeDataRLE,
        EntropyNaive, EntropyBatched, EntropyStrideSampled, EntropyStrideSampledBatched, Filter, FilterExt, FloatScalingMode,
