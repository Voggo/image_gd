...
pub use compression::{
    ...
    RleDeviationData, RleDeviationOffsetData, SaveEgdFile, SaveIgdFile, SelectBases,
    SelectBasesAdaptive, SelectBasesDebug, SelectBasesThreshold, SelectBasesProfileAllBits,
