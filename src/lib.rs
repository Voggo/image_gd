...
pub use compression::{
    ...
    CompressedData, CondensedSamples, DEFAULT_ALIGN_ROWS_TO_WORD, DecompressAnalytics,
    DecompressFileData, DecompressRowsData, DeltaBaseTableData, DeltaEncodeBaseTable,
    ...
    MAGIC_BYTES, PreEncodeContext, PreprocessOptions, RleDeviationData, SaveEgdFile, SaveIgdFile,
