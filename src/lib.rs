...
pub use compression::{
    ...
    EncodeDataFusedDictionary, EncodeDataHuffman, EncodeDataOptimized, EncodeDataRLE, EncodedData,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeData, EncodeDataFusedDictionary, EncodeDataHuffman, EncodeDataOptimized,
