...
pub use compression::{
    ...
    DeltaEncodeBaseTable, DeviationData, DeviationSample, EgdFile, EncodeData,
    EncodeDataFusedDictionary, EncodeDataHuffman, EncodeDataHuffmanBaseIdOnly, EncodeDataOptimized,
    EncodeDataRLE, EncodedData, EntropyBatched, EntropyBitScore, EntropyNaive,
    ...
    ImageReconstructionInfo, InferFeatureSpecs, LoadEgdFile, LoadIgdFile, MAGIC_BYTES,
    PreEncodeContext, PreprocessOptions, RleDeviationData, SaveEgdFile, SaveIgdFile, SelectBases,
    SelectBasesDebug, SelectBasesOptimized, SelectBasesProfileAllBits, calculate_entropy,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataOptimized, EncodeDataRLE, EntropyBatched, EntropyNaive, EntropyStrideSampled,
