...
pub use compression::{
    ...
    DeviationSample, EgdFile, EncodeData, EncodeDataFusedDictionary,
    EncodeDataFusedDictionarySinglePass, EncodeDataHuffman, EncodeDataOffsetRLE, EncodeDataRLE,
    EncodedData, Entropy, EntropyBitScore, EntropyScoredContext, FORMAT_VERSION, FeatureSpec,
    ...
    SelectBasesProfileAllBits, SelectBasesThreshold, calculate_entropy, decode_value_from_bits,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataFusedDictionary, EncodeDataFusedDictionarySinglePass, EncodeDataHuffman,
        EncodeDataOffsetRLE, EncodeDataRLE, Entropy, Filter, FilterExt, FloatScalingMode,
        GenCondensedSamples, ImageColorModel, ImageColorSpace, ImageGroupingTransform,
        InferFeatureSpecs, LoadEgdFile, LoadIgdFile, OpenImage, PixelGrouping, PreprocessOptions,
        SaveEgdFile, SaveIgdFile, SelectBases, SelectBasesAdaptive, SelectBasesDebug,
