...
pub use compression::{
    ...
    DeviationSample, EgdFile, EncodeData, EncodeDataHuffman, EncodeDataOffsetRLE, EncodeDataRLE,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataHuffman, EncodeDataOffsetRLE, EncodeDataRLE, Entropy, Filter, FilterExt,
        FloatScalingMode,
