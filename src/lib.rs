...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataOptimized, EncodeDataRLE, EntropyBatched,
        EntropyNaive, EntropyStrideSampled, EntropyStrideSampledBatched, Filter, FilterExt,
        FloatScalingMode, GenCondensedSamples, ImageColorModel, ImageColorSpace,
        ImageGroupingTransform, InferFeatureSpecs, LoadEgdFile, LoadIgdFile, PixelGrouping,
        PreprocessOptions, SaveEgdFile, SaveIgdFile, SelectBases, SelectBasesDebug,
