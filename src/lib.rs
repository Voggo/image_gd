...
pub use compression::{
    ...
    EncodeDataOptimized, EncodeDataRLE, EncodedData, EntropyBatched, EntropyBitScore, EntropyNaive,
...
pub mod prelude {
    pub use crate::{
        ...
        EncodeDataHuffman, EncodeDataOffsetRLE, EncodeDataOptimized, EncodeDataRLE, EntropyBatched,
