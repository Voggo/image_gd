...
pub use compression::{
    ...
    EncodedData, EntropyBatched, EntropyNaive, EntropyStrideSampled, EntropyStrideSampledBatched,
    ...
    MAGIC_BYTES, PreprocessOptions, RleDeviationData, SaveEgdFile, SaveIgdFile, SelectBases,
